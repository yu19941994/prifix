<template>
  <div class="bg--dark__100 h--100 d-flex justify-content-center align-items-center flex-column">
    <div class="d-flex align-items-center">
      <span class="material-icons text-white font--error">report_gmailerrorred</span>
